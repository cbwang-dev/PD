function [GSC_fd_output,w_GSC_fd_save] = GSC_fd_time_varying(STFT_mics, RIR_sources, desired_DOA, fs_RIR, overlap_ratio, mu, ...
                                  concentrating_speech_filename, speech_period, VAD_TD_threshold, ...
