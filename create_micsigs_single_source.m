function mic = create_micsigs_single_source(speech_filename_1, speech_filename_2, noise_filename, ...
    ...
    if bool_noise
%         noise = wgn(size(signal,1),size(signal,2),10*log10(0.1*var(signal_1(:,1))));
%         mic = signal + noise;
